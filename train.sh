...
for filepath in "${file_list[@]}"; do
    ...
    python trainer.py --num_epochs $num_epochs --ver_name $filename --do_train --do_eval --do_save --output_dir "output2/"
...
filename="all"
python trainer.py --num_epochs $num_epochs --ver_name $filename --do_train --do_save --output_dir "output2/"
echo "Finished executing training: $filename"
